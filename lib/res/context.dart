import 'package:abg/domain_data/custom_mixin/mixen_widgets/loading_widget.dart';
...
class TContext {
  ...
  CustomFooter get customFooter => CustomFooter(
    builder: (BuildContext context, LoadStatus? mode) {
      ...
      if (mode == LoadStatus.idle) {
        ...
        body = const LoadingWidget(); // Customize your loading indicator here
  ...
  static ThemeData getThemeData() {
    return ThemeData(
      ...
      listTileTheme: ListTileThemeData(selectedColor: CustomColors.selectedTileColor,selectedTileColor: CustomColors.selectedTileColor)
